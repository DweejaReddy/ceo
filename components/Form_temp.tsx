...
const Form = () => {
  const [form, setForm] = useState<form>(initRegister);

  // mutation
  const mutation = useMutation({
    mutationKey: ['createForm'],
    mutationFn: async (regisForm: form) => request("https://expo-backend.vercel.app/api",
      createFormMutation,
      {
  ...
  // <div className="w-full py-16 bg-white" id="form">
  ...
  //             <p className="text-lg text-red-600">{errors.phone}</p>
  //           )} */}
  //         </div>
  ...
  //             <p className="text-lg text-red-600">{errors.startup}</p>
  //           )} */}
  //         </div>
  ...
  //             <p className="text-lg text-red-600">{errors.place}</p>
  //           )} */}
  //         </div>
  ...
  //             <p className="text-lg text-red-600">{errors.website}</p>
  //           )} */}
  //         </div>
  ...
  //             <p className="text-lg text-red-600">{errors.sector}</p>
  //           )} */}
  //         </div>
  ...
  //             <p className="text-lg text-red-600">{errors.student}</p>
  //           )} */}
  //         </div>
  //       </div>
  ...
  //           <p className="text-lg text-red-600">{errors.checkbox}</p>
  //         )} */}
  ...
  return (
    <div id="form" className='mt-20'>
      ...
      <div className="py-4 flex flex-col justify-center items-center">
        <form onSubmit={handleSubmit}>
          <div className="overflow-hidden shadow sm:rounded-md mb-8 px-4">
            <div className="rounded-md bg-white px-4 py-5 sm:p-6">
              <div className="grid grid-cols-6 gap-6">
                ...
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <div className="mt-1 flex rounded-md shadow-sm">
                    <span className="inline-flex items-center rounded-l-md border border-r-0 border-gray-300 bg-gray-50 px-3 text-lg text-gray-500">
                      +91
                    </span>
                    <input
                      type="text"
                      ...
                      value={form.phone}
                      onChange={handleChange}
                      className="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg"
                    />
                  </div>
                </div>
          ...
          <div className="flex flex-col items-center">
            <button type="submit" className="w-1/2 md:w-1/4 inline-flex justify-center items-center rounded-md border border-transparent bg-indigo-600 py-4 px-6 text-lg font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
              Register
            </button>
          </div>
        </form>
